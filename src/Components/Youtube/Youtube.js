...
class Youtube extends Component {
	...
	componentDidMount(){
		fetch("https://www.googleapis.com/youtube/v3/search?key=AIzaSyCtUJcfmuN62JaGWj_yRbX8e9PnWO8--pA&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=6")
